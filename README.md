...
###### _Данные берутся из структуры организации, которая находится, путь: `vars_smartpetrol/monitoring/ "grafana_organizations"`, и выполняются c помощью роли: `monitoring/define_vars/main.yml`_
